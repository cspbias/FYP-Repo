...
Attacker Script – 3‑Phase Exploit for the Procurement Portal
...
BASE_URL        = "http://localhost"          # <‑‑ Change if you run on a port (e.g. http://localhost:8080)

LOGIN_URL       = f"{BASE_URL}/login.php"     # URL that processes the login POST
...
ADMIN_USER      = "admin"          # real admin username

ADMIN_PASS      = "admin123"       # real admin password
